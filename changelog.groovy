...
def gitHubNamespace = "jamesnetherton"
def gitHubProject = "wildfly-liquibase"

// Issue categories that we're interested in
def issueCategories = ['enhancement', 'task', 'bug']
...
def template = engine.createTemplate(new File("${project.basedir}/changelog.template")).make(binding)
