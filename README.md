...
```
cd $JBOSS_HOME
wget https://github.com/jamesnetherton/wildfly-liquibase/releases/download/1.1.0/wildfly-liquibase-distro-1.1.0.zip
unzip wildfly-liquibase-distro-1.1.0.zip
```
...
```
galleon.sh install com.github.jamesnetherton:wildfly-liquibase-galleon-pack:1.1.0 --dir=wildfly --layers=liquibase
```
